...
| 2. Were there any requirements that were difficult to implement? What do you think would make them easier to implement in future projects? | Reflecting on recent experiences, I found navigating APIs and authentication to be challenging, struggling with finding the right API and setting up authentication efficiently. In addition to that, organizing files using modules and imports was also tough, as managing dependencies and understanding their intricate interplay proved daunting despite efforts to streamline the process. |
